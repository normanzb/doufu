nsc.Browser.BrowserDetect = new function __nsc_Browser_BrowserDetect()
{
	this.OSEnum = 
	{
		Windows:"Windows", 
	...
	this.Init = function () 
	{
		this.Browser = this.searchString(this.dataBrowser) || nsc.Browser.BrowserDetect.BrowserEnum.Unknown;
		this.Version = this.searchVersion(navigator.userAgent)
			|| this.searchVersion(navigator.appVersion)
			|| "Unknown";
		this.OS = this.searchString(this.dataOS) || nsc.Browser.BrowserDetect.OSEnum.Unknown;
	}
